#!/usr/bin/env bash
# verify the historical locations use case queries on all functional pyomnigraph backends
...
for query_name in PlaceIdentity PlaceHierarchy PlaceNames PersonsOfPlace
do
