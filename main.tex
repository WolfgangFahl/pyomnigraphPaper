...
% Same author set as the 2022 predecessor paper (CEUR-WS Vol-3262, paper9).
% TODO(authors): fill in the missing ORCIDs, emails and affiliations.
...
% TODO(authors): Andrea Westerinen — participation pending (invitation 2026-07-22).
\author[3]{Andrea Westerinen}[%
orcid=TODO,
email=TODO,
]
...
\address[2]{TODO: affiliation}
\address[3]{TODO: affiliation}

\cortext[1]{Corresponding author.}

%% Abstract (author-provided text).
\begin{abstract}
% TODO(authors): write the abstract. Intentionally empty per content policy.
\end{abstract}
...
% TODO(authors): finalize. Per AGENTS.md, AI assistance in this project is
% limited to spelling/grammar and formatting/build tooling; AI is NOT used to
% generate scientific content, arguments or prose.

%% Bibliography
% \nocite{*} ensures the seeded references render before any \cite exists,
% so the first (Overleaf) build is clean. Remove once sections cite properly.
\nocite{*}
